...
urlpatterns = [
    ...
    path('produtos/<str:pk>', ProdutoCreateView.as_view(), name='detalhar_atualizar_produto_sem_barra'),
    path('produtos/<str:pk>/', ProdutoCreateView.as_view(), name='detalhar_atualizar_produto'),
